...
public:
    ...
    CComPtr<IMediaEventEx> GetMediaEvent()
    {
        return m_pEventEx;
    }
    CComPtr<IMediaSeeking> GetMediaSeeking()
    {
        return m_pSeeking;
    }
    CComPtr<IMediaPosition> GetMediaPosition()
    {
        return m_pPosition;
    }
    CComPtr<IBasicVideo> GetBasicVideo()
    {
        return m_pBasicVideo;
    }
    CComPtr<IBasicAudio> GetBasicAudio()
    {
        return m_pBasicAudio;
    }
    CComPtr<IVideoWindow> GetVideoWindow()
    {
